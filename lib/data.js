...
export const careerStats = [
  { v: "38", k: "Races Entered" },
  { v: "11", k: "Podiums" },
  { v: "6", k: "Wins" },
  { v: "9", k: "Fastest Laps" },
  { v: "2:14", k: "Best Lap · BIC" },
  { v: "241", k: "Top Speed km/h" },
];

export const achievements = [
  { year: "2024", title: "Race Wars India — Finalist", place: "Buddh International Circuit", icon: "trophy" },
  { year: "2024", title: "Class Podium — Time Attack", place: "Greater Noida, IN", icon: "trophy" },
  { year: "2023", title: "Personal Best — 2:14.0 Lap", place: "BIC · GP Circuit", icon: "speedo" },
  { year: "2023", title: "Stage 1 Build Complete — 320 BHP", place: "ATM Performance", icon: "chip" },
  { year: "2022", title: "FMSCI Competition License", place: "Motorsport India", icon: "flag" },
];
